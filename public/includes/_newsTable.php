...
?>
    <tr class="">
        ...
        <td class="p-3  text-center border-x-2 border-white/50 border-y-4"><a class=" flex justify-center text-black hover:bg-green-400 px-1 py-1 bg-green-500 rounded shadow-md" href="updateNews.php?updateID=<?= $row['id'] ?>">Opdatér</a></td>
